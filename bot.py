...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await context.bot.send_message(
        ...
        text="Я могу создавать расписание! Напиши мне номера аудиторий, их вместимость, номера групп и их размер.\n В виде:\n 1-25, 2-30, 3-29\n группа 1А-15 человек, группа IT078-23 человек, группа 3B-28 человек",
    )
...
def send_gpt_request(system_prompt: str, user_prompt: str):
    body = {
        "modelUri": "gpt://yandex_cloud_catalog/yandex_gpt_model",
